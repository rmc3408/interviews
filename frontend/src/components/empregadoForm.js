...
const inputDate_TailwindCSS_class = 'block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2' +
    ' appearance-none dark:text-white dark:focus:border-white focus:outline-none focus:ring-0 focus:border-white peer'
const labelDate_TailwindCSS_class = 'absolute text-sm text-gray-500 dark:text-gray-400 transform' +
